...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `coverPic` varchar(100) DEFAULT "https://drive.google.com/uc?export=view&id=1cQxbAQhRTxYT4vzBzE2T84eOk-fIAQep",
  `profilePic` varchar(100) DEFAULT 'https://drive.google.com/uc?export=view&id=1K9q6MdmJwRB5SCZDbWuWJwaaU1Tq7y70',
