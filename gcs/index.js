...
async function uploadFile() {
    try {
        const response = await drive.files.create({
            requestBody: {
                name: 'FILE_NAME_HERE', // Here goes the filename that will be uploaded, example: ${user-id}.jpg
                mimeType: 'image/jpg', // The extension of the file
            },
            media: {
                mimeType: 'image/jpg',
                body: readStream, // Here whe are passing the readed bytes of the image
            },
        });
